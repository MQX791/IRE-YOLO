    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = bbox_iou(pbox, tbox[i], feat_sz=obj_sz, WIoU=True, ratio=0.8)
                ...
                #iou = shape_iou(pbox, tbox[i], scale=1.5).squeeze()
                #iou = bbox_iou(pbox, tbox[i], MDPIoU=True, hw=tobj.size()[2] * tobj.size()[3]).squeeze()          # MPDIoU
